    ...
    IMapper mapper) : BaseApiController
{
    ...
    public async Task<ActionResult<MessageDto>> CreateMessage([FromBody] CreateMessageDto createMessageDto)
    {
        ...
        if (recipient == null || sender == null || sender.UserName == null || recipient.UserName == null) return BadRequest("Cannot sed message at this time");
    ...
    public async Task<ActionResult> DeleteMessage(int id)
    {
        ...
        if (message.SenderDeleted && message.RecipientDeleted) await unitOfWork.Complete();
